...
<div class="col-md-12 mt-5 ">
    ...
    <div class="card card-primary card-outline mb-4">
        ...
        <div class="card-header">
            <div class="card-title">Create Tuor</div>
        </div>
        <!--end::Header-->
        <!--begin::Form-->
        <form action="{{route('tours.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="card-body">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="noi_dung"  rows="10" cols="50" name="description" rows="3"></textarea>
                </div>
                <div class=" mb-3">
                    {{-- {{dd($categories)}} --}}
                ...
                <div class=" mb-3">
                    {{-- {{dd($categories)}} --}}
                    <label for="image" class="form-label">Domain</label>
                    <select class="form-select" name="domain" id="">
                ...
                <div class="mb-3">
                    <label for="price" class="form-lable">Availability</label>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="service"  rows="10" cols="50" name="include" rows="3"></textarea>
                </div>
                <div class="mb-3">
                    <label for="title" class="form-label">Un Include</label>
                    <textarea class="form-control" id="un_service"  rows="10" cols="50" name="un_include" rows="3"></textarea>
                </div>
            </div>
            <!--end::Body-->
            <!--begin::Footer-->
