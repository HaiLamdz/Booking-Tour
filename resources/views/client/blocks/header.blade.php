...
<head>
    ...
    <!-- Flaticon -->
    <link rel="stylesheet" href="{{asset('FE/assets/css/flaticon.min.css')}}">
    <!-- Font Awesome -->
    <link rel="stylesheet" href="{{asset('FE/assets/css/fontawesome-5.14.0.min.css')}}">
    <!-- Bootstrap -->
