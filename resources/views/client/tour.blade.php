            ...
            <div class="col-lg-3 col-md-6 col-sm-10 rmb-75">
                <div class="shop-sidebar mb-30">
                    ...
                    <div class="widget widget-activity" data-aos="fade-up" data-aos-duration="1500"
                        data-aos-offset="50">
                        <h6 class="widget-title">Danh Mục Tour</h6>
                        <ul class="radio-filter">
                            @foreach ($countByCate as $item)
                            <li>
                                <div style="margin-left: 20px">
                                    
                                    <label for="activity1"><a  href="{{route('tour_cate', $item->cate_id)}}">{{$item->title}}</a><span>{{$item->total_tours}}</span></label>
